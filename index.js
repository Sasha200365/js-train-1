...
// ПРОШУ ПОЯСНИТИ ЯК ЦЕ РЕАЛІЗУВАТИ - СТВОРИВШИ НОВИЙ УРОК, ПРИСВЯЧЕНИЙ ВИКОНАННЮ ЦЬОГО ДЗ!!!!
...
function checkDataType(value) {
  ...
  if (typeof value == "number") {
    return 'Значення "42" має тип "number".';
  }
  if (typeof value == "string") {
    return 'Значення "Hello" має тип "string".';
  }
  if (typeof value == "boolean") {
    return 'Значення "true" має тип "boolean".';
  }
  if (typeof value == "undefined") {
    return 'Значення "undefined" має тип "undefined".';
  }
}
